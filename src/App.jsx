...
function App() {
  ...
  const clickEvent = () => {
    console.log(editorContent); // Log content when Save button is clicked
  }
    ...
    <>
      <div className="mt-10 ml-5 mr-4">
        ...
        <div className="grid grid-cols-2">
          ...
          <Jodit onContentChange={setEditorContent} /> {/* Pass the setter function */}
        </div>
      </div>
      
      <button 
        className='py-3 px-5 mt-4 rounded bg-blue-600 text-white hover:bg-blue-800 ml-5' 
        onClick={clickEvent}>
        Save
      </button>
    </>
